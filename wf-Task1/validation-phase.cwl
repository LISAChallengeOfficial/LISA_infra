...
cwlVersion: v1.0
class: Workflow
label: LISA 2025 - Tasks 10 workflow
...
inputs:
  ...
  pattern:
    ...
    type: string
    default: "BraTSPath_Val.*png$" --> needs update
...
steps:
  ...
  validate:
    doc: Validate submission, which should be a tar/zip of NIfTI files --> needs update we want to be a csv
